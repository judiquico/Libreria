...
public class ConstantesVista {
	...
	public static final String BTN_USUARIO = "Usuario";
	public static final String BTN_ADMINISTRADOR = "Administrador";
	// Constantes Dialogo Administrador
	public static final String TITULO_DIALOGO_ADMINISTRADOR = "Administrador";
